...
public class TransformationStack : Stack
{
    public TransformationStack() : base(
        new StackOptions 
        {
            ResourceTransformations = {
                RegisterAutoTags(new Dictionary<string, string> {
                        ...
                        { "User:Cost Center", "cost centre" },
                    }),
            }
        }
    ) {
        var bucket = new Bucket("automation-transformation-bucket");
        ...
        return args => {
            if (IsTaggable(args.Resource.GetResourceType())) {
                ...
                if (tagp != null) {
                    ...
                    try
                    {
                        tags = (InputMap<string>)tagp.GetValue(args.Args, null);
                    } 
                    catch(Exception e) 
                    {
                        Pulumi.Log.Exception(e);
                    }
